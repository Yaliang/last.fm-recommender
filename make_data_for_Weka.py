...
if __name__ == "__main__":
	...
	f = open("AllUsers.arff", "w")
	f.write("@relation training\n")
	f.write("\n")
	knn = KNN(2)

	for i in range(1, 12649):
		f.write("@attribute tagID_" + str(i) + " numeric\n")
	f.write("@attribute favID {")

	for artistID in ArtistManager:
		f.write(str(artistID) + ",")
		#sould delete the ',' before '}' manualy 
	f.write("}\n")
	...
	knn.training(UserManager, ArtistManager)
	#userCounter = 0
	for userID, feature in knn.Nodes.iteritems():
		userCounter += 1
